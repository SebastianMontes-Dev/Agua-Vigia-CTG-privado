...
| — | proceso | Retirado el pendiente «borrar `frontend/` del disco» de `estado-del-backend.md` y de la bitácora, ya cumplido | #26 | `ls frontend` → no existe · `git status` limpio · etiqueta `pre-retiro-frontend` intacta |
