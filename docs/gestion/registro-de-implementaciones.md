...
| RF003 · RNF003 | infra | Canal SSE con fetch, parser incremental y límite común de 5 s; conserva fecha y nulos, sondea a 30 s ante 429 y pausa oculto. F2 parcial, sin interfaz | #62 | canal-en-vivo.test.ts (9), canal-en-vivo.real.test.ts; consenso real de 3 huellas en San Bernardo; 137 unitarias local incluidas prueba real, CI verde; squash a8cb0aa verificado |
| RF001 · RF003 · RF037 | infra | Proxy F0 probado contra Spring, Mongo y Redis reales en dev y preview: 211 sectores, geometría, consenso SSE sin búfer, reporte, foto y portada. BUG-107/108 corregidos; ninguna nueva cobertura funcional declarada | #61 | verificar-proxy-real.mjs en 5173/4173; 127 unitarias, 16 E2E; CI en verde y squash afa7528 con autoría verificada |
| — | fix | Contrato de seis errores públicos alineado con ProblemDetail real; guía sin cola offline ADR-044; BUG-105/106/109 cerrados | #63 | Seis peticiones reales problem+json; regeneración sin cambios adicionales, 967 pruebas backend (1 omitida), contrato y frontend verdes; squash ef1d854 con autoría verificada |
| — | infra | Base PMTiles local fijada, 5 132 380 bytes, LFS, estilo neutro y glifos locales (ADR-072); F1 visual sigue pendiente | #64 | 139 unitarias, CI verde, descarga oficial verificada y SHA-256 registrado; squash c140d2e con autoría verificada |
