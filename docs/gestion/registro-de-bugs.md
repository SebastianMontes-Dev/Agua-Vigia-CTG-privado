...
| BUG-105 | 2026-09-25 | S2 | M2 | La guía de escalabilidad exige una cola offline contraria a ADR-044 | Abierto — reproducción: leer «Reportar sin hacer daño»; causa: recomendación antigua sin actualizar tras ADR-044; corrección pendiente en PR propio |
| BUG-106 | 2026-09-25 | S2 | API | OpenAPI tipa varios errores de foto, confirmación e histórico como éxito | Abierto — reproducción y respuesta real pendientes; causa probable: ApiResponse sin Content, Springdoc infiere retorno del controlador; comprobar antes de corregir |
...
Siguiente número disponible: BUG-109
-->
