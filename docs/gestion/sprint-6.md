...
| RF041 | Fuera del sprint salvo que lleguen credenciales de WhatsApp/Telegram; se declara como no cubierto. **Actualización 2026-09-24, tras el cierre:** se construyó por Telegram, armado y apagado hasta tener el token (`ADR-066`, `telegram.md`) | Credenciales de terceros |
...
| RF041 | No construido al cierre; construido después por Telegram y apagado (`ADR-066`) | Fuera de alcance del sprint |
