...
|---|---|---|---|
| El extracto PMTiles no se puede descargar desde la sesión en la nube: la política de red deniega `build.protomaps.com` | Ampliar la red del entorno o correr `scripts/extraer-mapa-base.sh` en la máquina del dueño | — | Abierto |
